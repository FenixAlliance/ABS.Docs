...
You can use the Alliance Business Platform APIs to access data stored on your Alliance Business Model, scoped to any given Business Tenants; Explore our documentation to learn more about how to use Alliance Business Systems's ABP APIs.

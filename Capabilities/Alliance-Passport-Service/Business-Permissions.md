...
Business Permissions can be granted through the [Alliance Business Studio](~/Capabilities/Alliance-Business-Studio.md) on the [Security Trail](~/Modules/SECURITY.md) Module.
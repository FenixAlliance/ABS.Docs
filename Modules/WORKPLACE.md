...
The ABS Workplace module is built on top of the Web Application Open Platform Interface (WOPI) protocol to integrate Office for the web with a storage container. The WOPI protocol enables Office for the web to access and change files that are stored in the [Alliance Business Platform](~/Capabilities/Alliance-Business-Platform.md).
